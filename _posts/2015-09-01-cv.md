...
* distributed, hypermedia-event-driven system leveraging AWS Kinesis and Lambda
* Intent-driven, event-sourced microservices architecture in F#/ASP.NET WebApi, leveraging DynamoDb
