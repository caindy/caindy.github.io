...
aws ec2 run-instances --user-data file://ec2deploy.sh --instance-type t2.nano --image-id ${AMZN_LINUX} --region us-east-1 --instance-initiated-shutdown-behavior terminate --security-groups blog-builder-sg --key-name mirage-blog-image-builder-keys
